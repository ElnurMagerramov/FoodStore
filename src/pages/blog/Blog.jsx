...
import headBack1 from "../../assets/image/home-banner-2.jpg";
...
export default function Blog() {
  return (
    <div>
      <Header pageName="Our Services" backgroundImage={headBack1} />
      <br />
      <br />
      <br />
        ...
        <div className="w-75 row justify-content-between w-mobile-100">
          <div className="col-lg-8 col-md-12 col-sm-12">
            <BlogArticle
              ...
              day="22"
              year="Jan 2018"
              articleHead="Lorem ipsum dolor sit amet consectetur elit"
            ...
            <BlogArticle
              ...
              day="18"
              year="Jan 2018"
              articleHead="Nulla ab minima maiores"
              articleInfo="Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Fusce eget dictum tortor. Donec dictum vitae sapien eu varius"
            />
            <BlogArticle
              articleLink="/blog/blog-content"
              ...
              day="16"
              year="Jan 2018"
              articleHead="Magni perspiciatis nulla vitae tempore"
              articleInfo="Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Fusce eget dictum tortor. Donec dictum vitae sapien eu varius"
            />
            <br />
            <nav aria-label="...">
              <ul className="pagination pagination-sm">
                <li className="page-item active me-3" aria-current="page">
                  <Link
                    className="page-link bg-secondary rounded-circle py-2 px-3 border-secondary"
                    to="/"
                  >
                    1
                  </Link>
                ...
                <li className="page-item">
                  <Link
                    className="page-link rounded-circle py-2 px-3 border-secondary text-secondary bg-transparent"
                    to="/"
                  >
                    2
                  </Link>
