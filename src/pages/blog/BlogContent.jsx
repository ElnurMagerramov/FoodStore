    ...
    return (
        <section className='d-flex justify-content-center my-5 flex-wrap'>
            <div className='d-flex justify-content-start w-75 px-4 text-muted'>
                <Link to="/" className='text-decoration-none text-muted pe-2'>Home</Link> &gt; <Link to="/blog" className='px-2 text-decoration-none text-muted'>Our Service</Link> &gt; Lorem ipsum dolor sit amet consectetur elit
            </div>
            <div className='w-75 d-flex justify-content-between mt-5'>
                <div className='col-lg-8'>
                    <span className='position-relative text-decoration-none'>
                        <img src={article1} alt="article_image" className='w-100' style={{ height: "400px" }} />
                    ...
                    <div className='row h6 justify-content-between mt-4'>
                        <div className='col-lg-7'><span className='text-muted'>By</span> Admin | 8 Comments</div>
                        <div className='col-lg-4'>
                        </div>
                    </div><br /><br /><br />
                    <h2 className='fw-bold'>Lorem ipsum dolor sit amet consectetur elit</h2>
                    <br />
