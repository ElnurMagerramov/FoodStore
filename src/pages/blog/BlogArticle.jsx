    ...
    return (
        <div>
            <Link to={props.articleLink} className='position-relative text-decoration-none'>
                <img src={props.articleImage} alt="article_image" className='w-100' style={{height:"400px"}}/>
            ...
            <div className='row h6 justify-content-between mt-4 col-sm-12'>
                <div className='col-lg-7 col-md-5'><span className='text-muted'>By</span> Admin | 8 Comments</div>
