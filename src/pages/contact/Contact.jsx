...
import headBack2 from "../../assets/image/home-banner-1.jpg"
            ...
            <div className='d-flex justify-content-center'>
                <div className='w-75 row'>
                    ...
                    <div className='col-lg-6 d-flex flex-column justify-content-center border border-secondary'>
                        <ContactInfo contactIcon={faLocationPin} contactHead="Address" contactInfo="Center 8th floor, 379 Hudson St, New York, NY 10018 US" textColor="text-muted" />
