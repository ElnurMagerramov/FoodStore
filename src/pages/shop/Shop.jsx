...
export default function Shop(props) {
  ...
  const [shopData, setShopData] = useState(props.basicData);
      ...
      <div className="w-75">
        <div className="d-flex mt-4 justify-content-between flex-wrap">
          ...
          >
            ...
            <li>
              <TabSelector
                isActive={selectedTab === "meyve"}
                onClick={() => setSelectedTab("meyve")}
              >
                Fruits
              </TabSelector>
            </li>
            <li>
              <TabSelector
                isActive={selectedTab === "tərəvəz"}
                onClick={() => setSelectedTab("tərəvəz")}
              >
                Vegetables
              </TabSelector>
            </li>
            <li>
              <TabSelector
                isActive={selectedTab === "taxıl"}
                onClick={() => setSelectedTab("taxıl")}
              >
                Cereals
              </TabSelector>
            </li>
            <li>
              <TabSelector
                isActive={selectedTab === "digər"}
                onClick={() => setSelectedTab("digər")}
              >
                Others
              </TabSelector>
            </li>
        ...
        <div className="row">
        {
          selectedTab === "all"?shopData.map((order) => (
              <ShopContent
